...
uint8_t  IS2020::avrcpGetCapabilities(uint8_t deviceId, uint8_t capId) {
  ...
  // DBG_AVRCP((char*)"AVRCP_Get_Capability_command_for_Events");
...
uint8_t  IS2020::avrcpListPlayerAttributes(uint8_t deviceId) {
  IS2020::getNextEventFromBt();
  // DBG_AVRCP((char*)"AVRCP_List_Player_Attributes");
...
uint8_t  IS2020::avrcpListPlayerValues(uint8_t deviceId, uint8_t attribute) {
  IS2020::getNextEventFromBt();
  // DBG_AVRCP((char*)"AVRCP_List_Player_Values");
...
uint8_t  IS2020::avrcpGetCurrentPlayerValue(uint8_t deviceId, uint8_t attribute) {
  IS2020::getNextEventFromBt();
  // DBG_AVRCP((char*)"AVRCP_Get_Current_Player_Value");
...
uint8_t  IS2020::avrcpSetPlayerValue(uint8_t deviceId, uint8_t attribute, uint8_t value) {
  IS2020::getNextEventFromBt();
   DBG_AVRCP((char*)"AVRCP_Set_Player_Value");
...
uint8_t  IS2020::avrcpGetPlayerAttributeText(uint8_t deviceId, uint8_t attribute) {
  IS2020::getNextEventFromBt();
   DBG_AVRCP((char*)"AVRCP_Get_Player_Attribute_Text");
...
uint8_t  IS2020::avrcpGetPlayerValueText(uint8_t deviceId, uint8_t attributeID, uint8_t valueID) {
  IS2020::getNextEventFromBt();
  // DBG_AVRCP((char*)"AVRCP_Get_Player_Value_Text");
...
uint8_t  IS2020::avrcpGetElementAttributes(uint8_t deviceId) {
  IS2020::getNextEventFromBt();
  // DBG_AVRCP((char*)"AVRCP Get element attributes command");
...
uint8_t  IS2020::avrcpGetPlayStatus(uint8_t deviceId) {
  IS2020::getNextEventFromBt();
   DBG_AVRCP((char*)"AVRCP_Get_Element_Attributes");
...
uint8_t  IS2020::avrcpAbortContinuing(uint8_t deviceId, uint8_t pdu) {
  IS2020::getNextEventFromBt();
   DBG_AVRCP((char*)"AVRCP_Abort_Continuing");
...
uint8_t  IS2020::avrcpSetAbsoluteVolume(uint8_t deviceId, uint8_t volume) {
  IS2020::getNextEventFromBt();
   DBG_AVRCP((char*)"AVRCP_Set_Absolute_Volume");
...
uint8_t  IS2020::avrcpSetAddressedPlayer(uint8_t deviceId, uint16_t player) {
  IS2020::getNextEventFromBt();
   DBG_AVRCP((char*)"AVRCP_Set_Addressed_Player");
...
uint8_t  IS2020::avrcpSetBrowsedPlayer(uint8_t deviceId, uint16_t player) {
  IS2020::getNextEventFromBt();
   DBG_AVRCP((char*)"AVRCP_SET_BROWSED_PLAYER");
...
void IS2020::decodeAvrcpPdu(uint8_t pdu) {
  DBG_AVRCP((char*)"Decoded PDU event: ");
  switch (pdu)
  {
    /* PDU types for metadata transfer */
    case AVRCP_GET_CAPABILITIES:
       DBG_AVRCP((char*)"AVRCP_GET_CAPABILITIES");
      break;
    ...
    case AVRCP_CT_BATTERY_STATUS:
       DBG_AVRCP((char*)"AVRCP_CT_BATTERY_STATUS");
      break;
    case AVRCP_GET_ELEMENT_ATTRIBUTES:
       DBG_AVRCP((char*)"AVRCP_GET_ELEMENT_ATTRIBUTES");
      break;
    case AVRCP_GET_PLAY_STATUS:
       DBG_AVRCP((char*)"AVRCP_GET_PLAY_STATUS");
      break;
    case AVRCP_REGISTER_NOTIFICATION:
       DBG_AVRCP((char*)"AVRCP_REGISTER_NOTIFICATION");
      break;
    ...
    case ACRCP_SET_ADDRESSED_PLAYER:
       DBG_AVRCP((char*)"ACRCP_SET_ADDRESSED_PLAYER");
      break;
    case AVRCP_SET_BROWSED_PLAYER:
       DBG_AVRCP((char*)"AVRCP_SET_BROWSED_PLAYER");
      break;
    case AVRCP_GET_FOLDER_ITEMS:
       DBG_AVRCP((char*)"AVRCP_GET_FOLDER_ITEMS");
      break;
    case AVRCP_CHANGE_PATH:
       DBG_AVRCP((char*)"AVRCP_CHANGE_PATH");
      break;
    case AVRCP_GET_ITEM_ATTRIBUTES:
       DBG_AVRCP((char*)"AVRCP_GET_ITEM_ATTRIBUTES");
      break;
    case AVRCP_PLAY_ITEM:
       DBG_AVRCP((char*)"AVRCP_PLAY_ITEM");
      break;
    case AVRCP_SEARCH:
       DBG_AVRCP((char*)"AVRCP_SEARCH");
      break;
    case AVRCP_ADD_TO_NOW_PLAYING:
       DBG_AVRCP((char*)"AVRCP_ADD_TO_NOW_PLAYING");
      break;
    case AVRCP_GENERAL_REJECT:
       DBG_AVRCP((char*)"AVRCP_GENERAL_REJECT");
      break;
    default:
      DBG_AVRCP((char*)"Unknown: ");
  }
}


void IS2020::decodeAvrcpEvent(uint8_t Event) {
  DBG_AVRCP((char*)"Decoded AVRCP event: ");
  switch (Event)
  {
    case AVRCP_EVENT_PLAYBACK_STATUS_CHANGED:
       DBG_AVRCP((char*)"AVRCP_EVENT_PLAYBACK_STATUS_CHANGED");
      break;
    case AVRCP_EVENT_TRACK_CHANGED:
       DBG_AVRCP((char*)"AVRCP_EVENT_TRACK_CHANGED");
      break;
    case AVRCP_EVENT_TRACK_REACHED_END:
       DBG_AVRCP((char*)"AVRCP_EVENT_TRACK_REACHED_END");
      break;
    case AVRCP_EVENT_TRACK_REACHED_START:
       DBG_AVRCP((char*)"AVRCP_EVENT_TRACK_REACHED_START");
      break;
    case AVRCP_EVENT_PLAYBACK_POS_CHANGED:
       DBG_AVRCP((char*)"AVRCP_EVENT_PLAYBACK_POS_CHANGED");
      break;
    case AVRCP_EVENT_BATT_STATUS_CHANGED:
       DBG_AVRCP((char*)"AVRCP_EVENT_BATT_STATUS_CHANGED");
      break;
    case AVRCP_EVENT_SYSTEM_STATUS_CHANGED:
       DBG_AVRCP((char*)"AVRCP_EVENT_SYSTEM_STATUS_CHANGED");
      break;
    case AVRCP_EVENT_PLAYER_APPLICATION_SETTING_CHANGED:
       DBG_AVRCP((char*)"AVRCP_EVENT_PLAYER_APPLICATION_SETTING_CHANGED");
      break;
    case AVRCP_EVENT_NOW_PLAYING_CONTENT_CHANGED:
       DBG_AVRCP((char*)"AVRCP_EVENT_NOW_PLAYING_CONTENT_CHANGED");
      break;
    case AVRCP_EVENT_AVAILABLE_PLAYERS_CHANGED:
       DBG_AVRCP((char*)"AVRCP_EVENT_AVAILABLE_PLAYERS_CHANGED");
      break;
    case AVRCP_EVENT_ADDRESSED_PLAYER_CHANGED:
       DBG_AVRCP((char*)"AVRCP_EVENT_ADDRESSED_PLAYER_CHANGED");
      break;
    case AVRCP_EVENT_UIDS_CHANGED:
       DBG_AVRCP((char*)"AVRCP_EVENT_UIDS_CHANGED");
      break;
    case AVRCP_EVENT_VOLUME_CHANGED:
       DBG_AVRCP((char*)"AVRCP_EVENT_VOLUME_CHANGED");
      break;
    default:
      DBG_AVRCP((char*)"Unknown: ");
  }
...
void IS2020::decodeAvrcpPlayerAtributes(uint8_t attribute, uint8_t attrValue) {
  /* player attributes */
  DBG_AVRCP((char*)"Decoded player attribute: ");
  switch (attribute)
  {
    case AVRCP_ATTRIBUTE_ILLEGAL:
      DBG_AVRCP((char*)"Attribute illegal.");
      return;
    //break;
    ...
    case AVRCP_ATTRIBUTE_REPEAT_MODE:
      ...
      switch (attrValue) {
        case 0x01:
          ...
          break;
        case 0x02:
          DBG_AVRCP((char*)"single track");
          break;
        case 0x03:
          DBG_AVRCP((char*)"all tracks");
          break;
        case 0x04:
          DBG_AVRCP((char*)"group ");
          break;
      }
      break;
