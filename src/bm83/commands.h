...
#define CMD_LE_Signaling_Cmd  0x29
#define CMD_Read_IC_Version_Info  0x32
#define CMD_Configure_Vendor_Parameter 0x35
#define CMD_Read_Feature_List_Reply 0x39
#define Audio_Transceiver_Cmd 0x44
